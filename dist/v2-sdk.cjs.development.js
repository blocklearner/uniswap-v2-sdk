...
var FACTORY_ADDRESS = '0x260d2E9ee9867Eed08c594F3619cBdC6A576EfdA'
var INIT_CODE_HASH = '0x67afece463b64891c13546ab1249f241b6654938a3a09c4ecae813bdc0128ff2'
  ...
  _proto.getLiquidityMinted = function getLiquidityMinted(totalSupply, tokenAmountA, tokenAmountB) {
    ...
    if (JSBI.equal(totalSupply.raw, ZERO)) {
      liquidity = JSBI.subtract(
        sdkCore.sqrt(JSBI.multiply(tokenAmounts[0].raw, tokenAmounts[1].raw)),
        MINIMUM_LIQUIDITY
      )
    } else {
